...
const EnquiryFrom = () => {
    const {setEnquiry, conferenct, userId, currentConference} = useContext(DataContext)
  ...
  const handlesubmit = async (values, {setSubmitting, resetForm})=>{
    ...
    const save_enquiry_from = {
      ...
      "conferencedata":  currentConference[0]['id'],
   ...
   try{
    ...
    resetForm()
    toast.success('Thank you so much for your enquiry. Our salesperson will be in touch with you shortly.', {
     position: "top-center",
     autoClose: 5000,
    ...
    return (
        <>
           <div className="wrap container container-md mt-4 ">
  
            <div className='top_div shadow-lg px-4    container-sm   bg-white  container      m-auto justify-content-end '>
             ...
             <h3 className="title  ">ENQUIRY FORM </h3>
               ...
               validationSchema={EnquirySchema}   >
                   ...
                   <div className="row  ">
                       ...
                       <Field type='text' name='name'  placeholder=' ' className='w-100  input-trenprant'/>
                       
                       <br/>
                       {isSubmitted && touched.name && errors.name && <small>{errors.name}</small>}
                       
                       </div>
                      
                       <div className="col-12   col-md-6    text-start     ">
                         <label htmlFor="addHospital" className='form-label   ps-1 lable-sub   '>Hospital/Company</label>
                         <Field type='text' name='Hospital'  placeholder=' ' className='w-100 input-trenprant'/>
                        
                         <br/>
                         {isSubmitted && touched.Hospital && errors.Hospital && <small>{errors.Hospital}</small>}
                       </div>
                       ...
                       <label htmlFor="email" className='form-label  text-start ps-1 lable-sub'>Email </label>
                        ...
                        <br/>
                       {isSubmitted && touched.email && errors.email && <small>{errors.email}</small>}
                       </div>
                       
                       <div className="col-12  col-md-6  text-start  ">
                       <label htmlFor="MobileNumber" className='form-label  text-start d-flex flex-nowrap lable-sub ps-1'>Mobile Number</label>
                       <Field type='number' name='Mobile'   placeholder=' ' className='w-100 input-trenprant no-spinners'    />
                       
                       <br/>
                       {isSubmitted && touched.Mobile && errors.Mobile && <small>{errors.Mobile}</small>}
                       </div>
                       ...
                       {isSubmitted && touched.locations && errors.locations && <small>{errors.locations}</small>}
                       </div>
                      
                       <div className="col-12 col-md-6   text-start ">
                       <label htmlFor="Message" className='form-label   text-start   ps-1 lable-sub '>Message</label>
                       <Field type='text' name='message'  placeholder=' ' className='w-100 mt-md-3  input-trenprant'/>
                      
                       <br/>
                       
                       {isSubmitted && touched.message && errors.message && <small>{errors.message}</small>}
                       </div>
                           ...
                           className='SwiperSlideComman_circle'> 
                               ...
                               <SwiperSlide className='SwiperSlideComman_circle'> 
                                   <label className= {`comman_circle shadow-lg img_6 `}>
                                         ...
                                         <p className={`product_name flex-nowrap  `}>Surgical </p><p className={`product_name flex-nowrap  `}>Critical<span className='invisible'>#</span>Care</p>
                                     </label>
